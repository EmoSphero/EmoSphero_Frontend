 ...
 * @publish
 */
Adaptor.prototype.readServiceCharacteristic = function(
  serviceId,
  characteristicId,
  callback
) {
 ...
 * @publish
 */
Adaptor.prototype.writeServiceCharacteristic = function(
  serviceId,
  characteristicId,
  value,
  callback
 ...
 * @publish
 */
Adaptor.prototype.getCharacteristic = function(
  serviceId,
  characteristicId,
  callback
) {
...
Adaptor.prototype._connectCharacteristic = function(
  serviceId,
  characteristicId,
  callback
) {
  ...
  if (self._connectedCharacteristics(serviceId)) {
    ...
    s.discoverCharacteristics(null, function(charErr, characteristics) {
      ...
      if (characteristics.length > 0) {
        var characteristic = self._connectedCharacteristic(
          serviceId,
          characteristicId
        );
